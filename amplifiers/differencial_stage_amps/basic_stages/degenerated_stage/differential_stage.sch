...
C {sky130_fd_pr/res_high_po_0p35.sym} -30 90 0 0 {name=R10
L=1*1
model=res_high_po_0p35
spiceprefix=X
 mult=1}
C {sky130_fd_pr/res_high_po_0p35.sym} 190 90 0 1 {name=R11
L=1*1
model=res_high_po_0p35
spiceprefix=X
 mult=1}
C {devices/lab_pin.sym} -50 90 2 1 {name=p30 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 210 90 2 0 {name=p32 sig_type=std_logic lab=VDD}

...
C {devices/isource.sym} -40 130 0 0 {name=I0 value=300u}
...
C {devices/lab_pin.sym} 50 -60 2 1 {name=p17 sig_type=std_logic lab=VOUT+}
C {devices/lab_pin.sym} 160 -200 3 1 {name=p2 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -20 -170 0 0 {name=p3 sig_type=std_logic lab=VB2
}
C {devices/lab_pin.sym} 340 -170 2 0 {name=p23 sig_type=std_logic lab=VB2
}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 30 -170 0 0 {name=M9
L=1
W=15
nf=1 mult=1
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 290 -170 0 1 {name=M4
L=1
W=15
nf=1 mult=1
model=pfet_g5v0d10v5
...
C {devices/vsource.sym} -310 110 0 0 {name=V3 value=3.8}
C {devices/gnd.sym} -310 180 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} -310 40 0 0 {name=p1 sig_type=std_logic lab=VB2
}

...
C {devices/gnd.sym} 430 -40 0 0 {name=l1 lab=GND}
C {devices/vsource.sym} 100 -380 0 0 {name=V1 value=5
}
C {devices/vsource.sym} 180 -380 0 0 {name=V2 value=1.125
}
...
C {sky130_fd_pr/res_high_po_0p35.sym} 430 -290 2 0 {name=R1
L=1*8
model=res_high_po_0p35
spiceprefix=X
 mult=1}
C {devices/lab_pin.sym} 460 -290 2 0 {name=p11 sig_type=std_logic lab=VDD}
C {sky130_fd_pr/res_high_po_0p35.sym} 430 -90 2 0 {name=R8
L=0.35
model=res_high_po_0p35
spiceprefix=X
 mult=3}
C {devices/lab_pin.sym} 460 -90 2 0 {name=p18 sig_type=std_logic lab=VDD}
C {/home/vasco/Desktop/sky130A/amplifiers/single_stage_amps/basic_stages/ce_degenerated/ce_degenerated_stage.sym} 550 190 0 0 {name=x1}
C {/home/vasco/Desktop/sky130A/amplifiers/single_stage_amps/basic_stages/ce_degenerated/ce_degenerated_stage.sym} 560 500 0 0 {name=x2}
C {/home/vasco/Desktop/sky130A/amplifiers/single_stage_amps/basic_stages/ce_degenerated/ce_degenerated_stage.sym} 560 740 0 0 {name=x3}

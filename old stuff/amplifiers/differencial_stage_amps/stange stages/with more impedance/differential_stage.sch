...
C {devices/lab_pin.sym} 160 -380 3 1 {name=p1 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 50 -260 2 0 {name=p2 sig_type=std_logic lab=VOUT+}
C {devices/lab_pin.sym} 270 -260 0 0 {name=p3 sig_type=std_logic lab=VOUT-}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 30 -310 0 0 {name=M9
L=2.5
W=10
nf=1 mult=1
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 290 -310 0 1 {name=M4
L=2.5
W=10
nf=1 mult=1
model=pfet_g5v0d10v5
...
C {sky130_fd_pr/res_high_po_0p35.sym} 50 -220 0 1 {name=R6
L=1*1
model=res_high_po_0p35
spiceprefix=X
 mult=1}
C {sky130_fd_pr/res_high_po_0p35.sym} 270 -220 0 0 {name=R1
L=1*1
model=res_high_po_0p35
spiceprefix=X
 mult=1}

...
C {devices/vsource.sym} 180 -380 0 0 {name=V2 value=0.065
}
...
C {devices/lab_pin.sym} 640 -140 2 0 {name=p5 sig_type=std_logic lab=VOUT}
...
C {devices/res.sym} 600 -110 0 0 {name=R2
value=10G
footprint=1206
device=resistor
m=1}
...
C {/home/vasco/Desktop/sky130A/amplifiers/single_stage_amps/basic_stages/cd_resistive_stage/cd_resistive_stage.sym} 450 190 0 0 {name=x1}
C {/home/vasco/Desktop/sky130A/amplifiers/single_stage_amps/basic_stages/cd_resistive_stage/cd_resistive_stage.sym} 470 500 0 0 {name=x2}
C {/home/vasco/Desktop/sky130A/amplifiers/single_stage_amps/basic_stages/cd_resistive_stage/cd_resistive_stage.sym} 470 740 0 0 {name=x3}
C {devices/vsource.sym} 240 -380 0 0 {name=V6 value=1
}

...
C {/home/vasco/Desktop/sky130A/folded_cascode_amplifier/2_stage/second_stage.sym} 1120 20 0 0 {name=x3}
...
C {devices/lab_pin.sym} 1040 50 0 0 {name=p23 sig_type=std_logic lab=VB4
}
C {devices/lab_pin.sym} 1040 70 0 0 {name=p24 sig_type=std_logic lab=VB3
}
C {/home/vasco/Desktop/sky130A/folded_cascode_amplifier/detector/detector_1.sym} 1060 240 0 1 {name=x4}
C {devices/lab_pin.sym} 1120 190 1 0 {name=p25 sig_type=std_logic lab=VDD}
C {/home/vasco/Desktop/sky130A/folded_cascode_amplifier/cmfb_amp/cmfb_amp.sym} 880 240 0 1 {name=x5}
C {devices/lab_pin.sym} 970 200 1 0 {name=p26 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1010 230 0 1 {name=p27 sig_type=std_logic lab=VB
}
C {devices/lab_pin.sym} 1020 300 0 1 {name=p28 sig_type=std_logic lab=VB2
}
C {devices/lab_pin.sym} 1020 320 0 1 {name=p29 sig_type=std_logic lab=VB1
}
C {devices/gnd.sym} 970 300 0 1 {name=l8 lab=GND}
C {devices/lab_pin.sym} 830 250 1 1 {name=p30 sig_type=std_logic lab=VCM
}

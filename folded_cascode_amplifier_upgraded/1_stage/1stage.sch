...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 230 190 0 0 {name=M11
L=1.8
W=10
nf=1 mult=1
model=nfet_g5v0d10v5
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 860 190 0 1 {name=M12
L=1.8
W=10
nf=1 mult=1
model=nfet_g5v0d10v5
...
C {devices/lab_pin.sym} 210 190 2 1 {name=p41 sig_type=std_logic lab=VCMFB}
C {devices/lab_pin.sym} 880 190 2 0 {name=p42 sig_type=std_logic lab=VCMFB}

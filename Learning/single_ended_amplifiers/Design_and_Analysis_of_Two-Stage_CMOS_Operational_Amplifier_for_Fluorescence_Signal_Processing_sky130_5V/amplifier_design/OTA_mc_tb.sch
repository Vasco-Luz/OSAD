...
N -120 -20 -110 -30 {lab=VOUT_DC}
N -320 0 -260 0 {lab=VOUT_DC}
N -330 -0 -320 0 {lab=VOUT_DC}
N -380 -40 -260 -60 {lab=#net18}
N 840 -140 850 -150 {lab=VOUT_CM}
N 650 -970 680 -990 {lab=VIN+}
N 660 -930 680 -930 {lab=Va}
N 820 -950 830 -960 {lab=VOUT}
N 1360 -790 1430 -790 {lab=#net10}
N 1250 -850 1430 -850 {lab=#net9}
N 1250 -850 1250 -830 {lab=#net9}
N 1470 -750 1500 -770 {lab=#net12}
N 1570 -810 1580 -820 {lab=VOUT_A-}
N 1470 -250 1650 -250 {lab=#net14}
N 1470 -250 1470 -230 {lab=#net14}
N 1580 -190 1650 -190 {lab=#net15}
N 1690 -150 1720 -170 {lab=VSS}
N 1790 -210 1800 -220 {lab=VOUT_A+}
N 680 -120 700 -120 {lab=#net7}
...
C {devices/lab_pin.sym} 740 -40 0 0 {name=p12 sig_type=std_logic lab=VSS
}
...
C {devices/lab_pin.sym} -220 80 0 0 {name=p30 sig_type=std_logic lab=VSS
}
C {devices/lab_pin.sym} -220 -260 0 0 {name=p31 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -30 -20 3 0 {name=p32 sig_type=std_logic lab=VOUT_DC
}
C {ammeter.sym} -220 -190 0 0 {name=Vmeas1 savecurrent=true}
...
C {devices/vsource.sym} -440 -10 0 0 {name=V12 value= 2.5}

...
N 1320 -240 1400 -240 {lab=#net8}
N 1420 -300 1420 -240 {lab=#net8}
N 1420 -300 1500 -300 {lab=#net8}
N 1500 -300 1500 -270 {lab=#net8}
N 1260 -140 1260 -100 {lab=VSS}
N 1260 -100 1440 -100 {lab=VSS}
N 1280 -110 1280 -100 {lab=VSS}
N 1500 -240 1500 -210 {lab=VSS}
N 1400 -240 1460 -240 {lab=#net8}
N 1500 -210 1500 -100 {lab=VSS}
N 1440 -100 1500 -100 {lab=VSS}
N 1260 -240 1280 -240 {lab=VSS}
N 1260 -240 1260 -140 {lab=VSS}
N 1280 -210 1280 -170 {lab=#net9}
N 240 -180 240 -140 {lab=#net10}
N 220 -210 240 -210 {lab=VSS}
N 220 -210 220 -110 {lab=VSS}
N 1280 -680 1380 -680 {lab=VDD}
N 1380 -680 1500 -680 {lab=VDD}
N 1280 -380 1280 -270 {lab=#net11}
N 1500 -380 1500 -300 {lab=#net8}
N 1220 -410 1280 -410 {lab=VSS}
N 1500 -410 1560 -410 {lab=VSS}
N 1320 -410 1460 -410 {lab=#net12}
N 1390 -470 1390 -410 {lab=#net12}
N 1390 -470 1500 -470 {lab=#net12}
N 1280 -470 1280 -440 {lab=#net13}
N 1280 -570 1280 -530 {lab=#net14}
N 1500 -480 1500 -470 {lab=#net12}
N 1500 -470 1500 -440 {lab=#net12}
N 1500 -580 1500 -550 {lab=#net15}
N 1500 -490 1500 -480 {lab=#net12}
N 1280 -640 1280 -610 {lab=VDD}
N 1320 -610 1460 -610 {lab=#net14}
N 1500 -640 1500 -610 {lab=VDD}
N 1390 -610 1390 -570 {lab=#net14}
N 1280 -570 1390 -570 {lab=#net14}
N 1280 -580 1280 -570 {lab=#net14}
...
C {sky130_fd_pr/nfet_g5v0d10v5_nf.sym} 380 -210 0 0 {name=M37
L=3
W=1.2
nf=2 mult=2
model=nfet_g5v0d10v5
...
C {sky130_fd_pr/pfet_g5v0d10v5_nf.sym} 880 -610 0 0 {name=M40
L=2.5
W=1
nf=2 mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5_nf.sym} 700 -610 0 1 {name=M2
L=2.5
W=1
nf=2 mult=2
model=pfet_g5v0d10v5
...
C {sky130_fd_pr/pfet_g5v0d10v5_nf.sym} 1480 -610 0 0 {name=M3
L=2.5
W=1
nf=2 mult=2
model=pfet_g5v0d10v5
...
C {sky130_fd_pr/pfet_g5v0d10v5_nf.sym} 1300 -610 0 1 {name=M4
L=2.5
W=1
nf=2 mult=2
model=pfet_g5v0d10v5
...
C {sky130_fd_pr/nfet_g5v0d10v5_nf.sym} 1480 -240 0 0 {name=M5
L=3
W=1.2
nf=2 mult=2
model=nfet_g5v0d10v5
...
C {sky130_fd_pr/nfet_g5v0d10v5_nf.sym} 1300 -240 0 1 {name=M6
L=3
W=1.2
nf=2 mult=8
model=nfet_g5v0d10v5

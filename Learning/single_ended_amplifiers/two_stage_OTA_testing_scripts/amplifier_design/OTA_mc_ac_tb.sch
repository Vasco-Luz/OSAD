...
C {sky130_fd_pr/corner.sym} -390 -750 0 0 {name=CORNER only_toplevel=true corner=mc}
...
C {devices/vsource.sym} 500 -610 0 0 {name=V5 value= "VCM"}
...
C {devices/vsource.sym} 1250 -580 0 0 {name=V8 value= "VCM"}
C {devices/vsource.sym} 1470 20 0 0 {name=V12 value= "VCM"}
C {devices/vsource.sym} 520 90 0 0 {name=V6 value= "VCM"}

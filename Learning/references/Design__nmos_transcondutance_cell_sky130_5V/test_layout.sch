...
C {devices/code.sym} -960 -80 0 0 {name=spice only_toplevel=false
...
.param VDD = 5
.param VSS = 0
.include ../../../foss/designs/OSAD/Learning/single_ended_amplifiers/Design_transcondutance_cell_sky130_5V/pmos_current_mirror.spice
...
C {pmos_current_mirror.sym} -300 -120 0 0 {name=x1}

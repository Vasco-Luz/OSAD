...
if simulation == 1:
    ...
    data = pd.read_csv("current_mirror.csv", delim_whitespace=True, header=None)
...
if simulation == 2:
    ...
    for current_corner in corners:
        ...
        data_c = pd.read_csv("current_mirror.csv", delim_whitespace=True, header=None)
...
if (simulation == 3): 
    ...
    sim_comands.write_corner(netlist, "mos_tt_stat")
    data_mc = []

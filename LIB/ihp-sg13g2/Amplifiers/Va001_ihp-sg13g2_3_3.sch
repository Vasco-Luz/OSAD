...
N 700 -190 1130 -190 {lab=VDD}
N 640 -100 640 -30 {lab=#net4}
N 570 -30 640 -30 {lab=#net4}
N 710 -30 760 -30 {lab=#net4}
N 800 0 860 0 {lab=VIN+}
N 420 0 480 0 {lab=VIN-}
N 520 200 520 230 {lab=#net5}
N 780 370 880 370 {lab=VSS}
...
N -390 120 -320 120 {
lab=VOUT}
N 520 0 570 0 {lab=#net4}
N 570 -30 570 0 {lab=#net4}
N 520 -30 570 -30 {lab=#net4}
N 710 0 760 -0 {lab=#net4}
N 710 -30 710 0 {lab=#net4}
N 640 -30 710 -30 {lab=#net4}
N 640 -190 640 -160 {lab=VDD}
N 640 -130 700 -130 {lab=VDD}
N 700 -190 700 -130 {lab=VDD}
N 640 -190 700 -190 {lab=VDD}
N -20 -130 0 -130 {lab=VDD}
N -20 -190 -20 -130 {lab=VDD}
N 220 -190 640 -190 {lab=VDD}
N 0 -190 0 -160 {lab=VDD}
N -20 -190 0 -190 {lab=VDD}
N 190 -190 190 -160 {lab=VDD}
N 0 -190 190 -190 {lab=VDD}
N 190 -130 220 -130 {lab=VDD}
N 220 -190 220 -130 {lab=VDD}
N 190 -190 220 -190 {lab=VDD}
N 520 290 520 370 {lab=VSS}
N 480 370 520 370 {lab=VSS}
N 480 260 520 260 {lab=VSS}
N 760 290 760 370 {lab=VSS}
N 520 370 760 370 {lab=VSS}
N 760 260 780 260 {lab=VSS}
N 780 260 780 370 {lab=VSS}
N 760 370 780 370 {lab=VSS}
N 1130 290 1130 370 {lab=VSS}
N 1130 260 1160 260 {lab=VSS}
N 1160 260 1160 370 {lab=VSS}
N 1130 370 1160 370 {lab=VSS}
N 1130 -190 1130 -160 {lab=VDD}
N 1130 -130 1140 -130 {lab=VDD}
N 1140 -190 1140 -130 {lab=VDD}
N 1130 -190 1140 -190 {lab=VDD}
N 480 260 480 370 {lab=VSS}
N 190 370 480 370 {lab=VSS}
...
C {sg13g2_pr/sg13_hv_nmos.sym} 20 20 0 1 {name=M3
l=2u
w=1.0u
ng=2
m=2
...
C {sg13g2_pr/sg13_hv_nmos.sym} 170 20 0 0 {name=M4
l=2u
w=1.0u
ng=2
m=2
...
C {sg13g2_pr/sg13_hv_nmos.sym} 20 170 0 1 {name=M5
l=2u
w=2u
ng=2
m=8
...
C {sg13g2_pr/sg13_hv_nmos.sym} 170 170 0 0 {name=M6
l=2u
w=2u
ng=2
m=2
...
C {sg13g2_pr/sg13_hv_nmos.sym} 540 260 0 1 {name=M10
l=2u
w=2u
ng=2
m=2
...
C {sg13g2_pr/sg13_hv_nmos.sym} 740 260 0 0 {name=M11
l=2u
w=2u
ng=2
m=2
...
C {sg13g2_pr/sg13_hv_nmos.sym} 1110 260 0 0 {name=M13
l=0.8u
w=2u
ng=2
m=4
